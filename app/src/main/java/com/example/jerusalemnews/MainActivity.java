...
public class MainActivity extends AppCompatActivity {
    ...
    TextView textView_confirmed, textView_confirmed_new, textView_active,
            textView_active_new, textView_recovered, textView_recovered_new,
            textView_death, textView_death_new, textView_tests, textView_date,
            textView_tests_new, textview_time;
    ...
    public void openvideo(View view) {
        Intent intent = new Intent(this, CoronaVideo.class);
        startActivity(intent);
    }

    public void TipsandAdvice(View view) {
        Intent intent = new Intent(this, TipsandAdvice.class);
        startActivity(intent);
    }
}
