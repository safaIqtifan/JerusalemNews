...
public class PerStateData extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String stateName = intent.getStringExtra(StatewiseDataActivity.STATE_NAME);
        String stateConfirmed = intent.getStringExtra(StatewiseDataActivity.STATE_CONFIRMED);
        String stateActive = intent.getStringExtra(StatewiseDataActivity.STATE_ACTIVE);
        String stateDeceased = intent.getStringExtra(StatewiseDataActivity.STATE_DECEASED);
        String stateNewConfirmed = intent.getStringExtra(StatewiseDataActivity.STATE_NEW_CONFIRMED);
        String stateNewRecovered = intent.getStringExtra(StatewiseDataActivity.STATE_NEW_RECOVERED);
        String stateNewDeceased = intent.getStringExtra(StatewiseDataActivity.STATE_NEW_DECEASED);
        String stateLastUpdate = intent.getStringExtra(StatewiseDataActivity.STATE_LAST_UPDATE);
        String stateRecovery = intent.getStringExtra(StatewiseDataActivity.STATE_RECOVERED);
